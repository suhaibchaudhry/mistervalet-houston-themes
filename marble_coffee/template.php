 ...
 * template.php
 */
function marble_coffee_js_alter(&$js) {
...
function marble_coffee_menu_tree__primary(&$variables) {
 return '<ul class="nav navbar-nav navbar-right">' . $variables['tree'] . '</ul>';
}

function marble_coffee_preprocess_page (&$variables) {
...
function marble_coffee_menu_link(array $variables) {
 ...
 */
function marble_coffee_form_alter(array &$form, array &$form_state = array(), $form_id = NULL) {
  if ($form_id) {
