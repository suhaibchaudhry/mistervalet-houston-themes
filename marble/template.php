...
function marble_menu_tree__primary(&$variables) {
 return '<ul class="nav navbar-nav navbar-right">' . $variables['tree'] . '</ul>';
}

function marble_preprocess_page (&$variables) {
...
function marble_menu_link(array $variables) {
 ...
 */
function marble_form_alter(array &$form, array &$form_state = array(), $form_id = NULL) {
  if ($form_id) {
